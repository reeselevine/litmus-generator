...
public:
    ...
    void createBuffers() {
        ...
        */
        VkDeviceSize memorySize = bufferSize * 3;
    ...
    void createDescriptorSetLayout() {
        ...
        */
        ...
        descriptorSetLayoutCreateInfo.bindingCount = 3; // three bindings in this descriptor set layout. 
    ...
    void cleanup() {
        ...
        */
        ...
        vkDestroyBuffer(device, bufferC, NULL);	
